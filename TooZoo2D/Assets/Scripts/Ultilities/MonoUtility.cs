...
public static class MonoUtility
{
    ...
    #region Extension
    public static void SetAnchorPreset(this RectTransform rect, AnchorPreset anchorPreset)
    {
        Vector2 preset = Vector2.zero;
        switch (anchorPreset)
        {
            case AnchorPreset.TopLeft:
                preset = new Vector2(0, 1);
                break;
            case AnchorPreset.TopMid:
                preset = new Vector2(0.5f, 1);
                break;
            case AnchorPreset.TopRight:
                preset = new Vector2(1, 1);
                break;
            case AnchorPreset.MidLeft:
                preset = new Vector2(0, 0.5f);
                break;
            case AnchorPreset.Center:
                preset = new Vector2(0.5f, 0.5f);
                break;
            case AnchorPreset.MidRight:
                preset = new Vector2(1, 0.5f);
                break;
            case AnchorPreset.BotLeft:
                preset = new Vector2(0, 0);
                break;
            case AnchorPreset.BotMid:
                preset = new Vector2(0.5f, 0);
                break;
            case AnchorPreset.BotRight:
                preset = new Vector2(1, 0);
                break;
        }

        rect.anchorMax = preset;
        rect.anchorMin = preset;
    }
    #endregion
